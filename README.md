...
Leaflet has lots of [plugins](https://leafletjs.com/plugins.html) that can be used along with the library to add capabilities not available in Leaflet. 
...
![](Images/map_trail_color_pop.png)
